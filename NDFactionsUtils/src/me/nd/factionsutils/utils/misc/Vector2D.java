...
public class Vector2D {
    ...
    /**
     * Add a list of vectors to this vector and return the result as a new
     * vector.
     *
    ...
    /**
     * Subtract a list of vectors from this vector and return the result as a
     * new vector.
     *
     * @param others an array of vectors
     * @return a new vector
    ...
    /**
     * Get the normalized vector, which is the vector divided by its length, as
     * a new vector.
     *
     * @return a new vector
     */
