...
public class SLogger extends PluginLogger {
  ...
  public SLogger(SLogger parent, String prefix) {
    super(parent.plugin);
  ...
  public SLogger getModule(String module) {
    return new SLogger(this, module + ": ");
  }
